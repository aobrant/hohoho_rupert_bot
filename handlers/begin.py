    ...
    if counter < 20:
        ...
        if message_status == "good":
            ...
            prompt = "Ты " + personage + ", настоящий, все по канону. На все вопросы отвечаешь, как если бы ты был " \
                                         ...
                                         "ограничение PG-13. Стараешься давать им добрые, хорошие советы и пожелания, не больше двадцати слов," \
                                         " здоровайся не больше одного раза за весь диалог" \
                                         "даже если они пишут грубости. Предыдущий разговор был такой '" + old_prompt + \
                     "', учти это но на старые вопросы не отвыечай, а теперь отвечай  на новый вопрос с учетом предыдущего диалого, как бы продолжая разговор. На грубые вопросы не отвечай. Новый вопрос " + user_text
