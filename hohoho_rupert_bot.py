    ...
    if counter < 10:
        ...
        if message_status == "good":
            ...
            prompt = "Ты " + personage + ", настоящий, все по канону. На все вопросы отвечаешь, как если бы ты был " \
                     ...
                     "', учти это но на старые вопросы не отвыечай, а теперь отвечай  на новый вопрос с учетом предыдущего диалого, как бы продолжая разговор. Новый вопрос " + user_text
