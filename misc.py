...
async def picture(content: text, user_id):
    response = await client.images.generate(
        model="dall-e-3",
        prompt="На основании тем предыдущего разговора,  содержание '" + content + "' сделай  поздравительную открытку"
                                                                                   " с новым годом, если присудствуют желания они все"
                                                                                   " должны быть на открытке, не используй образ санты, "
               "и ВАЖНО!не пиши никаких текстов и букв: ",
        size='1024x1024',
        quality="standard",
        n=1,
    )
